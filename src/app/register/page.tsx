        ...
        <div className="bg-primary h-100">
            <main className="p-16">
                ...
                <div className="mt-12 flex flex-col gap-10 pl-6">
                    ...
                    <button className="p-5 w-2xl bg text-white bg-teal-700 rounded-2xl text-2xl text-bold cursor-pointer ease-in-out hover:bg-teal-800 transition-transform duration-300 hover:translate-x-2" type="button" onClick={register}>Registrar Agora</button>
                    <div className="flex items-center justify-center gap-2 w-2xl">
                        <hr className="bg-black w-16" />
